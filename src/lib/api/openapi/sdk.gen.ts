 ...
 * Get Video Frame
 */
export const getVideoFrameApiV1ProjectsPidMediaMidFramesFrameIdxGet = <ThrowOnError extends boolean = false>(options: Options<GetVideoFrameApiV1ProjectsPidMediaMidFramesFrameIdxGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetVideoFrameApiV1ProjectsPidMediaMidFramesFrameIdxGetResponses, GetVideoFrameApiV1ProjectsPidMediaMidFramesFrameIdxGetErrors, ThrowOnError>({
